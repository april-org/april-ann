 ...
 *
 */
#ifndef SINACTFCOMPONENT_H
#define SINACTFCOMPONENT_H
...
namespace ANN {
  ...
  /// A component which computes the Sin activation function.
  class SinActfANNComponent : public ActivationFunctionANNComponent {
