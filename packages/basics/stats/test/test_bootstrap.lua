...
T("BootstrapTest",
  function()
    ...
    -- p-value tests
    check.number_eq(stats.boot.pvalue(boot_result, b), 0.025, 0.05)
    check.number_eq(1.0 - stats.boot.pvalue(boot_result, a), 0.025, 0.05)
    check.number_eq(stats.boot.pvalue(boot_result, m, 1), 0.500)
end)
