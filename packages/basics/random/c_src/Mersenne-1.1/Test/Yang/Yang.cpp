// Yang.cpp
// Test output and speed of Yang's Mersenne Twister class
...
{
	printf( "Testing output and speed of Yang's Mersenne Twister class\n" );
