...
if [ $UNAME = "Linux" ]; then
  if [ `which apt-get` ]; then
    apt-get install pkg-config libz-dev libreadline-dev libblas-dev libatlas-dev libpng12-dev libtiff-dev liblua5.2-dev libncurses5 libncurses5-dev liblapacke-dev ||
