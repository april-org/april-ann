cmdOptTest = cmdOpt{
  ...
  main_description = "HMM/ANN training with April toolkit",
  {
    index_name="defopt",
  ...
  {
    index_name="train_s",
    description="Initial segmentation file for training set (optional)",
    long="train-s",
    argument="yes",
  },
  {
    index_name="train_phdict",
    description="Phonetical dictionary for training (optional)",
    long="train-phdict",
    argument="yes",
  },
  {
  ...
  {
    index_name="val_s",
    description="Initial segmentation file for validation set (optional)",
    long="val-s",
    argument="yes",
  },
  {
    index_name="val_phdict",
    description="Phonetical dictionary for validation (optional)",
    long="val-phdict",
    argument="yes",
  },
  {
    index_name="begin_sil",
    description="Initial silence (optional)",
    long="begin-sil",
    argument="yes",
  },
  {
    index_name="end_sil",
    description="Final silence (optional)",
    long="end-sil",
    argument="yes",
  },
  {
  ...
  },
  {
    ...
    description = "Table with means and devs for features (optional)",
    long        = "feats-norm",
    argument    = "yes",
    filter      = dofile,
  },
  ...
  {
    index_name  = "mean",
    description = "Mean of gaussian perturbation (default 0)",
    long        = "mean",
    argument    = "yes",
    mode="always",
    default_value=0,
  ...
  },
  {
    ...
    description="Initial MLP for continue an stopped training (optional)",
    long="initial-mlp",
    argument="yes",
  },
  {
    index_name="initial_hmm",
    description="Initial HMM for continue an stopped training, or to use as a first HMM description (optional)",
    long="initial-hmm",
    argument="yes",
  },
  {
    index_name="initial_em_epoch",
    description="Initial EM epoch for continue an stopped training (optional)",
  ...
  },
  {
    ...
    description="Filter the transcriptions to generate phonetic sequences (optional)",
